...
public class RebortActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.rebort);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.rebortt, null);
			}
			...
			if (lm.get((int)_position).containsKey("id")) {
				if (lm.get((int)_position).containsKey("name")) {
					textview1.setText("Name: ".concat(_data.get((int)_position).get("name").toString()));
				}
				if (lm.get((int)_position).containsKey("title")) {
					textview2.setText("Title: ".concat(_data.get((int)_position).get("title").toString()));
				}
				if (lm.get((int)_position).containsKey("massage")) {
					textview3.setText("Message: ".concat(_data.get((int)_position).get("massage").toString()));
				}
			}
