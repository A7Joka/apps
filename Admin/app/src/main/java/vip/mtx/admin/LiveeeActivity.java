...
public class LiveeeActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.liveee);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				map = new HashMap<>();
				map.put("live", edittext1.getText().toString());
				map.put("user", edittext2.getText().toString());
				map.put("referer", edittext3.getText().toString());
				map.put("finsh", edittext4.getText().toString());
				map.put("key", key);
				mt.child(key).updateChildren(map);
