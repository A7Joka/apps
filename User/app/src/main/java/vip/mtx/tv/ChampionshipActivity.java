...
public class ChampionshipActivity extends AppCompatActivity {
	...
	public void _Setting() {
		...
		if (settings.getString("language", "").equals("AR")) {
			textview1.setText("اختر احد البطولات");
		}
		else {
			textview1.setText("Choose A Championship");
		}
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.champion, null);
			}
			...
			if (settings.getString("theme", "").equals("Light")) {
				...
				linear1.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)10, 0xFF78022C));
			}
			else {
				textview1.setTextColor(0xFFFFFFFF);
			...
			textview1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/neosansarabic.ttf"), 1);
			if (list.get((int)_position).containsKey("nam")) {
				textview1.setText(list.get((int)_position).get("nam").toString());
			}
