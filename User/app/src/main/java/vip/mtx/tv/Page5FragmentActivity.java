...
public class Page5FragmentActivity extends Fragment {
	...
	private ObjectAnimator buttonAnim = new ObjectAnimator();
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.page5_fragment, _container, false);
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		buttonBG.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				i.setClass(getContext().getApplicationContext(), EngActivity.class);
				startActivity(i);
			}
		});
	}
	...
	public void onStart() {
		super.onStart();
		_CR(top, "#78022C", 0, 0, 100, 0);
		_CR(bottom, "#FFFFFF", 100, 0, 0, 0);
		_CR_SYTStudio(buttonBG, "#78022C", "#FFFFFF", 25, 25, 25, 25, 0, "#78022C", 0);
	}
