...
public class ImageViewPro extends ImageView {
    ...
    public ImageViewPro (Context var1) { 
        super(var1); 
        this.context = var1;
    } 

    public ImageViewPro(Context var1, AttributeSet var2) { 
        super(var1, var2); 
        this.context = var1;
        run();
    } 
    public void img(){
        Bitmap bm = ((android.graphics.drawable.BitmapDrawable) ImageViewPro.this.getDrawable()).getBitmap(); ImageViewPro.this.setImageBitmap(getRoundedCornerBitmap(bm, 25)); 
